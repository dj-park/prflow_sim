...
wire   [7:0] tmp_3_fu_50_p1;
reg   [7:0] tmp_3_reg_235;
reg   [7:0] tmp_4_reg_240;
reg   [7:0] tmp_6_reg_245;
wire   [7:0] tmp_7_fu_84_p1;
reg   [7:0] tmp_7_reg_250;
reg   [7:0] tmp_9_reg_255;
reg   [7:0] tmp_10_reg_260;
reg   [6:0] tmp_reg_265;
reg   [6:0] tmp_1_reg_270;
reg   [6:0] tmp_2_reg_275;
wire   [7:0] tmp_5_fu_64_p4;
wire   [7:0] mul_ln1543_fu_122_p0;
wire   [9:0] mul_ln1543_fu_122_p1;
wire   [16:0] mul_ln1543_fu_122_p2;
wire   [7:0] tmp_8_fu_88_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        tmp_10_reg_260 <= {{input_mi[31:24]}};
        tmp_1_reg_270 <= {{mul_ln1543_1_fu_142_p2[16:10]}};
        tmp_2_reg_275 <= {{mul_ln1543_2_fu_162_p2[16:10]}};
        tmp_3_reg_235 <= tmp_3_fu_50_p1;
        tmp_4_reg_240 <= {{input_lo[15:8]}};
        tmp_6_reg_245 <= {{input_lo[31:24]}};
        tmp_7_reg_250 <= tmp_7_fu_84_p1;
        tmp_9_reg_255 <= {{input_mi[23:16]}};
...
assign ap_return_0 = tmp_3_reg_235;

assign ap_return_1 = tmp_4_reg_240;

assign ap_return_2 = tmp_6_reg_245;

assign ap_return_3 = tmp_7_reg_250;

assign ap_return_4 = tmp_9_reg_255;

assign ap_return_5 = tmp_10_reg_260;

assign ap_return_6 = add_ln223_1_fu_193_p2;

assign mul_ln1543_1_fu_142_p0 = mul_ln1543_1_fu_142_p00;

assign mul_ln1543_1_fu_142_p00 = tmp_8_fu_88_p4;
...
assign mul_ln1543_fu_122_p00 = tmp_5_fu_64_p4;

assign mul_ln1543_fu_122_p1 = 17'd342;

assign tmp_3_fu_50_p1 = input_lo[7:0];

assign tmp_5_fu_64_p4 = {{input_lo[23:16]}};

assign tmp_7_fu_84_p1 = input_mi[7:0];

assign tmp_8_fu_88_p4 = {{input_mi[15:8]}};
