...
module prj_rast1_rasterization1_i1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'b1 == Output_1_TREADY))) begin
        max_min_V_1 <= lhs_6_fu_392_p3;
        max_min_V_2 <= rhs_6_fu_354_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'b1 == Output_1_TREADY))) begin
        max_min_V_3 <= lhs_5_fu_303_p3;
        max_min_V_4 <= rhs_5_fu_259_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln163_fu_195_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ...
    end else if ((~((ap_start == 1'b0) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY))) & (icmp_ln163_fu_195_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) | (1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2) | (1'b1 == ap_CS_fsm_state8) | (1'b1 == ap_CS_fsm_state7) | (1'b1 == ap_CS_fsm_state6) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state5) & (1'b1 == Output_1_TREADY)) | ((1'b1 == ap_CS_fsm_state4) & (1'b1 == Output_1_TREADY)) | ((1'b1 == ap_CS_fsm_state3) & (1'b1 == Output_1_TREADY)) | ((1'b1 == ap_CS_fsm_state2) & (1'b1 == Output_1_TREADY)) | ((1'b1 == ap_CS_fsm_state8) & (1'b1 == Output_1_TREADY)) | ((1'b1 == ap_CS_fsm_state7) & (1'b1 == Output_1_TREADY)) | ((1'b1 == ap_CS_fsm_state6) & (1'b1 == Output_1_TREADY)) | (~((1'b1 == ap_block_state1_io) | (ap_start == 1'b0) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY))) & (icmp_ln163_fu_195_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_block_state1_io) | (ap_start == 1'b0) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((1'b1 == ap_block_state1_io) | (ap_start == 1'b0) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY))) & (icmp_ln163_fu_195_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state6;
            end else if ((~((1'b1 == ap_block_state1_io) | (ap_start == 1'b0) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY))) & (icmp_ln163_fu_195_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY)));
end

always @ (*) begin
    ap_block_state1_io = ((icmp_ln163_fu_195_p2 == 1'd1) & (1'b0 == Output_1_TREADY));
end
...
assign icmp_ln163_fu_195_p2 = ((ret_V_17_fu_149_p2 == ret_V_20_fu_183_p2) ? 1'b1 : 1'b0);

assign lhs_5_fu_303_p3 = ((icmp_ln1081_fu_273_p2[0:0] == 1'b1) ? select_ln56_fu_284_p3 : select_ln63_fu_296_p3);

assign lhs_6_fu_392_p3 = ((icmp_ln1081_3_fu_368_p2[0:0] == 1'b1) ? select_ln56_1_fu_376_p3 : select_ln63_1_fu_386_p3);

assign p_Result_1_fu_527_p5 = {{{{{{1'd0}, {max_min_V}}}, {max_min_V_1}}}, {max_min_V_2}};
...
assign p_Result_s_fu_504_p4 = {{{max_min_V_3}, {max_min_V_4}}, {max_index_V}};
...
assign rhs_5_fu_259_p3 = ((icmp_ln1073_fu_229_p2[0:0] == 1'b1) ? select_ln36_fu_240_p3 : select_ln43_fu_252_p3);

assign rhs_6_fu_354_p3 = ((icmp_ln1073_3_fu_330_p2[0:0] == 1'b1) ? select_ln36_1_fu_338_p3 : select_ln43_1_fu_348_p3);

assign select_ln36_1_fu_338_p3 = ((icmp_ln1073_4_fu_334_p2[0:0] == 1'b1) ? triangle_2d_same_y0_V_reg_621 : triangle_2d_y2);

assign select_ln36_fu_240_p3 = ((icmp_ln1073_1_fu_235_p2[0:0] == 1'b1) ? triangle_2d_same_x0_V_fu_224_p3 : triangle_2d_x2);

assign select_ln43_1_fu_348_p3 = ((icmp_ln1073_5_fu_344_p2[0:0] == 1'b1) ? triangle_2d_same_y1_V_reg_610 : triangle_2d_y2);

assign select_ln43_fu_252_p3 = ((icmp_ln1073_2_fu_247_p2[0:0] == 1'b1) ? triangle_2d_same_x1_V_fu_214_p3 : triangle_2d_x2);

assign select_ln56_1_fu_376_p3 = ((icmp_ln1081_4_fu_372_p2[0:0] == 1'b1) ? triangle_2d_same_y0_V_reg_621 : triangle_2d_y2);

assign select_ln56_fu_284_p3 = ((icmp_ln1081_1_fu_279_p2[0:0] == 1'b1) ? triangle_2d_same_x0_V_fu_224_p3 : triangle_2d_x2);

assign select_ln63_1_fu_386_p3 = ((icmp_ln1081_5_fu_382_p2[0:0] == 1'b1) ? triangle_2d_same_y1_V_reg_610 : triangle_2d_y2);

assign select_ln63_fu_296_p3 = ((icmp_ln1081_2_fu_291_p2[0:0] == 1'b1) ? triangle_2d_same_x1_V_fu_214_p3 : triangle_2d_x2);
...
endmodule //prj_rast1_rasterization1_i1
