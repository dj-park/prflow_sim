...
module rast2_i1_rasterization2_Pipeline_VITIS_LOOP_85_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1073_fu_125_p2;
...
wire   [63:0] zext_ln1073_fu_137_p1;
reg   [15:0] j_fu_48;
wire   [15:0] add_ln85_fu_131_p2;
wire    ap_loop_init;
reg   [15:0] ap_sig_allocacmp_j_1;
reg    ap_block_pp0_stage0_01001;
wire   [29:0] p_Result_s_fu_150_p5;
wire  signed [30:0] sext_ln414_fu_162_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1073_fu_125_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            j_fu_48 <= add_ln85_fu_131_p2;
...
always @ (*) begin
    if (((icmp_ln1073_fu_125_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign Output_1_TDATA = $unsigned(sext_ln414_fu_162_p1);

assign add_ln85_fu_131_p2 = (ap_sig_allocacmp_j_1 + 16'd1);
...
assign fragment_color_V_address0 = zext_ln1073_fu_137_p1;

assign fragment_x_V_address0 = zext_ln1073_fu_137_p1;

assign fragment_y_V_address0 = zext_ln1073_fu_137_p1;

assign fragment_z_V_address0 = zext_ln1073_fu_137_p1;

assign icmp_ln1073_fu_125_p2 = ((ap_sig_allocacmp_j_1 == i_V_reload) ? 1'b1 : 1'b0);

assign p_Result_s_fu_150_p5 = {{{{fragment_color_V_q0}, {fragment_z_V_q0}}, {fragment_y_V_q0}}, {fragment_x_V_q0}};

assign sext_ln414_fu_162_p1 = $signed(p_Result_s_fu_150_p5);

assign zext_ln1073_fu_137_p1 = ap_sig_allocacmp_j_1;

endmodule //rast2_i1_rasterization2_Pipeline_VITIS_LOOP_85_1
