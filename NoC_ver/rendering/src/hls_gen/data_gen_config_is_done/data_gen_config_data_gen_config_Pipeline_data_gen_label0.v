...
module data_gen_config_data_gen_config_Pipeline_data_gen_label0 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln232_fu_552_p1;
wire   [63:0] zext_ln232_1_fu_571_p1;
wire   [63:0] zext_ln232_2_fu_590_p1;
wire   [63:0] zext_ln232_3_fu_609_p1;
reg   [9:0] i_fu_72;
wire   [9:0] add_ln88_fu_538_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i_1;
reg    ap_block_pp0_stage0_01001;
wire   [11:0] shl_ln_fu_544_p3;
wire   [11:0] or_ln100_fu_565_p2;
wire   [11:0] or_ln111_fu_584_p2;
wire   [11:0] or_ln122_fu_603_p2;
wire   [456:0] p_Result_s_fu_627_p41;
reg    ap_done_reg;
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_x0_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_x0_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_y0_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_y0_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_z0_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_z0_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_x1_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_x1_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_y1_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_y1_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_z1_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_z1_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_x2_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_x2_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_y2_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_y2_V_U(
...
data_gen_config_data_gen_config_Pipeline_data_gen_label0_triangle_3ds_z2_V_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 3192 ),
    .AddressWidth( 12 ))
triangle_3ds_z2_V_U(
...
data_gen_config_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
    .ap_ready(ap_ready),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln88_fu_532_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_72 <= add_ln88_fu_538_p2;
...
always @ (*) begin
    if (((icmp_ln88_fu_532_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign Output_2_TDATA = p_Result_s_fu_627_p41;

assign add_ln88_fu_538_p2 = (ap_sig_allocacmp_i_1 + 10'd1);
...
assign icmp_ln88_fu_532_p2 = ((ap_sig_allocacmp_i_1 == 10'd798) ? 1'b1 : 1'b0);

assign or_ln100_fu_565_p2 = (shl_ln_fu_544_p3 | 12'd1);

assign or_ln111_fu_584_p2 = (shl_ln_fu_544_p3 | 12'd2);

assign or_ln122_fu_603_p2 = (shl_ln_fu_544_p3 | 12'd3);

assign p_Result_s_fu_627_p41 = {{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{1'd0}, {triangle_3ds_z2_V_q0}}}, {triangle_3ds_y2_V_q0}}}, {triangle_3ds_x2_V_q0}}}, {triangle_3ds_z1_V_q0}}}, {triangle_3ds_y1_V_q0}}}, {triangle_3ds_x1_V_q0}}}, {triangle_3ds_z0_V_q0}}}, {triangle_3ds_y0_V_q0}}}, {triangle_3ds_x0_V_q0}}}, {56'd0}}}, {triangle_3ds_z2_V_q1}}}, {triangle_3ds_y2_V_q1}}}, {triangle_3ds_x2_V_q1}}}, {triangle_3ds_z1_V_q1}}}, {triangle_3ds_y1_V_q1}}}, {triangle_3ds_x1_V_q1}}}, {triangle_3ds_z0_V_q1}}}, {triangle_3ds_y0_V_q1}}}, {triangle_3ds_x0_V_q1}}}, {56'd0}}}, {triangle_3ds_z2_V_q2}}}, {triangle_3ds_y2_V_q2}}}, {triangle_3ds_x2_V_q2}}}, {triangle_3ds_z1_V_q2}}}, {triangle_3ds_y1_V_q2}}}, {triangle_3ds_x1_V_q2}}}, {triangle_3ds_z0_V_q2}}}, {triangle_3ds_y0_V_q2}}}, {triangle_3ds_x0_V_q2}}}, {56'd0}}}, {triangle_3ds_z2_V_q3}}}, {triangle_3ds_y2_V_q3}}}, {triangle_3ds_x2_V_q3}}}, {triangle_3ds_z1_V_q3}}}, {triangle_3ds_y1_V_q3}}}, {triangle_3ds_x1_V_q3}}}, {triangle_3ds_z0_V_q3}}}, {triangle_3ds_y0_V_q3}}}, {triangle_3ds_x0_V_q3}};

assign shl_ln_fu_544_p3 = {{ap_sig_allocacmp_i_1}, {2'd0}};

assign triangle_3ds_x0_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_x0_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_x0_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_x0_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_x1_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_x1_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_x1_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_x1_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_x2_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_x2_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_x2_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_x2_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_y0_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_y0_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_y0_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_y0_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_y1_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_y1_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_y1_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_y1_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_y2_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_y2_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_y2_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_y2_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_z0_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_z0_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_z0_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_z0_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_z1_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_z1_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_z1_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_z1_V_address3 = zext_ln232_fu_552_p1;

assign triangle_3ds_z2_V_address0 = zext_ln232_3_fu_609_p1;

assign triangle_3ds_z2_V_address1 = zext_ln232_2_fu_590_p1;

assign triangle_3ds_z2_V_address2 = zext_ln232_1_fu_571_p1;

assign triangle_3ds_z2_V_address3 = zext_ln232_fu_552_p1;

assign zext_ln232_1_fu_571_p1 = or_ln100_fu_565_p2;

assign zext_ln232_2_fu_590_p1 = or_ln111_fu_584_p2;

assign zext_ln232_3_fu_609_p1 = or_ln122_fu_603_p2;

assign zext_ln232_fu_552_p1 = shl_ln_fu_544_p3;

endmodule //data_gen_config_data_gen_config_Pipeline_data_gen_label0
