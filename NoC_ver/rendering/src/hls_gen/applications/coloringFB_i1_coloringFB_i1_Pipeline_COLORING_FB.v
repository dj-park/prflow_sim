...
module coloringFB_i1_coloringFB_i1_Pipeline_COLORING_FB (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_140)) begin
        if ((icmp_ln33_fu_106_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln33_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (icmp_ln33_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        Input_1_TREADY = 1'b1;
    end else begin
        Input_1_TREADY = 1'b0;
    end
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (icmp_ln33_fu_106_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (tmp_fu_158_p3 == 1'd1) & (icmp_ln33_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (tmp_fu_158_p3 == 1'd0) & (icmp_ln33_fu_106_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0)));
end

always @ (*) begin
    ap_condition_140 = (~((ap_start_int == 1'b0) | ((1'b0 == Input_1_TVALID) & (icmp_ln33_fu_106_p2 == 1'd0))) & (1'b1 == ap_CS_fsm_state1));
end

assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;

assign coloringFB_i1_stream_ap_uint_32_0_stream_ap_uint_32_0_frame_buffer_1_address0 = zext_ln40_fu_152_p1;

assign coloringFB_i1_stream_ap_uint_32_0_stream_ap_uint_32_0_frame_buffer_1_d0 = {{Input_1_TDATA[23:16]}};

assign coloringFB_i1_stream_ap_uint_32_0_stream_ap_uint_32_0_frame_buffer_address0 = zext_ln40_fu_152_p1;

assign coloringFB_i1_stream_ap_uint_32_0_stream_ap_uint_32_0_frame_buffer_d0 = {{Input_1_TDATA[23:16]}};

assign i_V_3_fu_112_p2 = (ap_sig_allocacmp_i_V + 16'd1);

assign icmp_ln33_fu_106_p2 = ((ap_sig_allocacmp_i_V == tmp_V_cast) ? 1'b1 : 1'b0);

assign lshr_ln_fu_130_p4 = {{Input_1_TDATA[15:9]}};

assign tmp_fu_158_p3 = Input_1_TDATA[32'd8];

assign tmp_s_fu_144_p3 = {{trunc_ln40_fu_140_p1}, {lshr_ln_fu_130_p4}};

assign trunc_ln40_fu_140_p1 = Input_1_TDATA[7:0];

assign zext_ln40_fu_152_p1 = tmp_s_fu_144_p3;

endmodule //coloringFB_i1_coloringFB_i1_Pipeline_COLORING_FB
